...
from src.webscraping.webscraper import WebScraper as ws
...
if __name__ == '__main__':
    ...
    # product_info 에 있는 image_url을 S3에 저장해서 public url을 product 테이블에 저장
    ws.get_data_from_site()

    #네이버에서 크롤링한 이미지 S3에 저장 후 DB에 public url 저장
    # gi.get_naver_image_upload_to_s3()
